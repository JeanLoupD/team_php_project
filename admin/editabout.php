                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                <label for="aboutTitle" class="form-label">Edit About Title</label>
                                <textarea class="form-control" style="height: 100px" type="text" id="aboutTitle" name="aboutTitle" maxlength="150" autocomplete="off"><?php echo $_SESSION['aboutTitle']; ?></textarea>
                            </div>
                            <!-- Sub Title -->
                            <div class="mb-3 col-md-6">
                                <label for="aboutSubTitle" class="form-label">Edit About Sub Title</label>
                                <textarea class="form-control" style="height: 100px" type="text" id="aboutSubTitle" name="aboutSubTitle" maxlength="150" autocomplete="off"><?php echo $_SESSION['aboutSubTitle']; ?></textarea>
                            </div>
                            <!-- Description -->
                            <div class="mb-3 col-md-6">
                                <label for="aboutDesc" class="form-label">Edit About Description</label>
                                <textarea class="form-control" style="height: 200px" type="text" id="aboutDesc" name="aboutDesc" maxlength="500" autocomplete="off"><?php echo $_SESSION['aboutDesc']; ?></textarea>
                            </div>
                        </div>
                        <div class="mt-2">
